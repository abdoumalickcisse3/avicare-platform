...
public class Client {
   ...
   *
   * <p>False by default and never inferred from a phone number being present: writing to a farmer's
   * own clients engages the farmer's name with them. Each send carries a second, per-message guard
   * on top of this one.
   */
