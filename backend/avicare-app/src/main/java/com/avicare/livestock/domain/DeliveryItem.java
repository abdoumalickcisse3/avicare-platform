...
/**
 * One line of a {@link Delivery} (Sprint B5-2), snapshot from the source order line: a PRODUCT
 * article with a delivered quantity and unit price. {@code lineTotalXof} = quantity × unitPriceXof
 * (HT only, D25). Timestamps DB-owned (trigger).
 */
@Entity
