...
public class SubscriptionService {
   ...
   * expired. Pure read — provisioning happens at farm creation (see {@code
   * SubscriptionFacade#provisionModules}), never here, so this stays safe in read-only contexts.
   */
  @Transactional(readOnly = true)
