...
SET value = '{"label":"Ferme Complete","price_xof":45000,"wave":"V1","recommended":false,'
            || '"modules":["module.poultry.broiler","module.poultry.layer",'
            || '"module.health.basic","module.health.advanced",'
            || '"module.commercial.basic","module.commercial.advanced",'
            || '"module.inventory","module.finance","module.kpi.advanced",'
            || '"module.buyer_portal","module.qr_codes","module.api_access"],'
            || '"quotas":{"farms_max":10,"animals_max":10000}}'::jsonb
...
SELECT 'bundles', 'sur_mesure',
       '{"label":"Sur mesure","price_xof":null,"wave":"V1","custom":true,'
       || '"recommended":false,"modules":[]}'::jsonb, NULL
WHERE NOT EXISTS (
