/**
 * Farmer-facing partner network surface — mirrors `web/src/store/api/partnersApi.ts`.
 * Farm-scoped; reads need farm membership and writes are OWNER/MANAGER-gated on the backend.
 * Mutations invalidate the "mine" list so the enriched (name/type) view re-fetches after a write.
 */
