 ...
 * is null in the V4 seed, so the create-batch screen pre-fills these when a breed is
 * picked. Mirrors `web/src/constants/breedDefaults.ts` — same codes, same values.
 * TECH DEBT: source these from the breed reference data once it carries a curve.
 */
