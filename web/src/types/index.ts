...
export interface PoultryBatch {
   ...
   * `initialCount - currentCount`: a sale decrements the count just as a death does, so
   * that formula reports every sold bird as dead. Both mobile screens once did.
   */
  deaths: number;
